...
/// generates a markdown report, and sends it back to the `stopPerformanceFlutterDriverTest` method.
...
/// }
/// ```
Future<void> perfDriverFlutterDriverTest({
  ...
  flutterDriverExtension(
    handler: (data) async {
      if (data != null) {
        ...
        final widgetBuildData =
            jsonData['widget_build'] as Map<String, dynamic>;
