...
Future<Map<String, dynamic>> getCpuUsage(
    VmService? vmService, String? isolateId) async {
  if (isolateId == null) {
    return <String, dynamic>{};
  }
  final timeline = await vmService?.getCpuSamples(
      isolateId, 0, DateTime.now().millisecondsSinceEpoch);
